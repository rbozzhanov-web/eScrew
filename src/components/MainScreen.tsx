...
const styles = StyleSheet.create({
  ...
  viewport:{flex:1,minHeight:0}, tabPane:{position:'absolute',top:0,left:0,right:0,bottom:0}, tabPaneHidden:{opacity:0}, screen:{flex:1,paddingTop:8,gap:12}, grow:{flex:1,minWidth:0}, sectionTitle:{fontSize:28,lineHeight:34,fontWeight:'700',letterSpacing:-.8}, intro:{fontSize:15,lineHeight:22}, label:{fontSize:10.5,fontWeight:'800',letterSpacing:1.05}, meta:{fontSize:13,lineHeight:18},
  ...
  infoCard:{borderWidth:1,borderRadius:24,padding:16,gap:4}, cardTitle:{fontSize:17,lineHeight:22,fontWeight:'700'}, libraryCard:{borderWidth:1,borderRadius:24,padding:16,minHeight:88,maxHeight:190}, libraryList:{marginTop:5}, libraryRow:{minHeight:56,flexDirection:'row',alignItems:'center',gap:10,borderBottomWidth:StyleSheet.hairlineWidth}, libraryMonth:{fontSize:14,fontWeight:'700'}, deleteRosterButton:{minWidth:58,height:34,borderRadius:14,alignItems:'center',justifyContent:'center',paddingHorizontal:8}, deleteRosterText:{fontSize:11,fontWeight:'700'}, expiryDate:{fontSize:12,fontWeight:'700',fontVariant:['tabular-nums'],...MONO_FONT},
  ...
  flightSheet:{width:'100%',maxWidth:620,maxHeight:'78%',alignSelf:'center',borderTopWidth:1,borderTopLeftRadius:30,borderTopRightRadius:30,paddingHorizontal:18,paddingBottom:12,overflow:'hidden',...WEB_GLASS}, flightSheetContent:{minHeight:0,flexShrink:1}, sheetRoute:{fontSize:28,lineHeight:33,fontWeight:'700',marginTop:5}, swipeHint:{fontSize:10,marginTop:7}, flyingWith:{fontSize:11,fontWeight:'700',letterSpacing:.45,opacity:.82,marginTop:12,marginBottom:7}, crewScroll:{minHeight:0,flexShrink:1,flex:1,...Platform.select({web:{maxHeight:'calc(78vh - 46px)' as any},default:{}})}, crewList:{paddingBottom:12,gap:7}, crewRow:{minHeight:64,flexDirection:'row',alignItems:'center',borderWidth:1,borderRadius:22,paddingHorizontal:14}, avatar:{width:42,height:42,borderRadius:21,alignItems:'center',justifyContent:'center',marginRight:12}, avatarText:{fontSize:13,fontWeight:'800'}, crewName:{fontSize:14,fontWeight:'600'},
